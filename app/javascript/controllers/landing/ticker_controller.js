...
export default class extends Controller {
  ...
  connect() {
    this.symbols = [
      { s: "AAPL",    p: 198.45, c: 1.23 },
      { s: "MSFT",    p: 445.12, c: -0.45 },
      { s: "GOOGL",   p: 178.90, c: 0.87 },
      { s: "NVDA",    p: 924.56, c: 2.34 },
      { s: "TSLA",    p: 178.30, c: -1.12 },
      { s: "AMZN",    p: 192.78, c: 0.56 },
      { s: "META",    p: 512.34, c: 1.67 },
      { s: "BTC",     p: 71245,  c: 0.89 },
      { s: "ETH",     p: 3567,   c: -0.34 },
      { s: "EUR/USD", p: 1.0867, c: 0.12 },
      { s: "SOL",     p: 187.45, c: 3.21 },
      { s: "AMD",     p: 178.90, c: 1.45 },
      { s: "NFLX",    p: 634.12, c: -0.23 },
      { s: "CRM",     p: 312.45, c: 0.78 },
